...
namespace ZKI_1_v2
{
    public partial class SinglePermutationWindow : Window
    {
            ...
            if(textBoxWord.Text != "" && textBoxWord.Text.Length < 91) 
            {
                ...
                if (textBoxKey.Text.Length > 1 && textBoxKey.Text.Length < 10)
                {
                    ...
                    if (checkBoxEncrypt.IsChecked == true)
                    {
                        ...
                        Files.SavingToFile($"D:\\Projects\\VS Projects\\ZKI_1&2_v2\\ZKI_1_v2\\SP\\encrypt.txt",
                            textBoxResult.Text);
                    }
                    else if (checkBoxDecrypt.IsChecked == true)
                    {
                        ...
                        Files.SavingToFile($"D:\\Projects\\VS Projects\\ZKI_1&2_v2\\ZKI_1_v2\\SP\\decrypt.txt",
                            textBoxResult.Text);
                    }
                    else
                    {
